...
class Common(Configuration):
    ...
    ADMINS = (
        ('Fábio Cáritas Barrionuevo da Luz', 'bnafta@gmail.com'),
    )
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/sisposto')
    ...
    TEMPLATE_CONTEXT_PROCESSORS = (
        ...
        'users.context_processors.posto',
    )
...
class Production(Common):
    ...
    EMAIL_SUBJECT_PREFIX = values.Value('[sgt] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
...
##########  Very ugly hack to force to Pycharm work
