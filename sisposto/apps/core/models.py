...
class Placa(ModeloBasico):
    ...
    veiculo = models.OneToOneField('Veiculo', related_name='placa')
...
class ConsumoCombustivel(models.Model):
    ...
    veiculo = models.ForeignKey('Veiculo', related_name='consumo_combustivel_veiculo')
...
class Veiculo(ModeloBasico):
    ...
    tipo_combustivel = models.ForeignKey('Combustivel', verbose_name=u'Tipo de Combustivel')
    ...
    consumo_medio_por_litro_teorico = models.DecimalField(verbose_name=u'Consumo Teórico de Combustivel por litro',
                                                          help_text=u'Gasto informado na documentação tecnica do veiculo',
                                                          max_digits=8,
                                                          decimal_places=2,
    ...
    categoria_habilitacao_minima = models.CharField(verbose_name='Categoria Minima', max_length=12, choices=CNH.CNHTipo,
    ...
    eh_caracterizado = models.BooleanField(verbose_name=u'É caracterizado?',
