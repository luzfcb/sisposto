    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_css_class', models.CharField(max_length=50, null=True, verbose_name='CSS class of icon', blank=True)),
                ('show_icon', models.BooleanField(default=False, verbose_name='Show icon of this item')),
                ('access_permissions', models.ManyToManyField(to='auth.Permission', verbose_name='Permissions granting access', blank=True)),
                ('parent', models.ForeignKey(related_name=b'smarttreeitem_parent', blank=True, to='core.SmartTreeItem', help_text='Parent site tree item.', null=True, verbose_name='Parent')),
                ('tree', models.ForeignKey(related_name=b'smarttreeitem_tree', verbose_name='Site Tree', to='sitetree.Tree', help_text='Site tree this item belongs to.')),
            ],
            options={
                'abstract': False,
